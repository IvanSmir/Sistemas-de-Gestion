...
import { reactivateEmployee } from '@/utils/detail.http';
import { useAuth } from '@/components/context/AuthProvider';
import { useRouter } from 'next/navigation';
import ConfirmAddEmployeeModal from './confirmModal';
    ...
    const isRuc = async () => {
        try {
            ...
            if (employeeResponse.isEmployee) {
                setEmployeeId(employeeResponse.idEmployee);
                if (employeeResponse.isDeleted) {
