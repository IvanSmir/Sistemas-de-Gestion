...
const ReportModal = ({ isOpen, onClose, reportData }) => {
    ...
    useEffect(() => {
        if (reportData.length > 0) {
            let ipsArray_= [], familyArray_ = [], incomeArray_ = [], totalArray_ = [];
            let ips_: number = 0, family_: number = 0, income_: number = 0, total_: number = 0;
        ...
        <Modal isOpen={isOpen} onClose={onClose}>
            ...
            <ModalContent>
                ...
                <ModalFooter>
                    ...
                    <PDFDownloadLink 
                        document={<ReportPDF reportData={reportData} selectedReport={selectedReport} ipsArray={ipsArray} totalArray={totalArray} familyArray={familyArray} incomeArray={incomeArray} />}
