...
import { SiberBar } from './SiberBar'
export const NavBar = () => {
  return (
   
<div className="flex items-center">
		<div className="flex flex-col w-full max-w-xs p-4 bg-pink-600	">
    <div className="flex items-center justify-center bg-pink-600	 py-4">
      <Link className="font-semibold" href="/">
        <span className="text-white">Ferreteria</span>
      </Link>
    </div>
      ...
      <ul className=" flex-col w-full">
				<li className="my-px">
					<a href="#"
					   className="flex flex-row items-center h-12 px-4 rounded-lg bg-pink-600	 bg-pink-100">
				...
				<li className="my-px">
					<a href="#"
					   className="flex flex-row items-center h-12 px-4 rounded-lg text-gray-600 hover:bg-gray-100">
						...
						<span className="ml-3">Datos generales</span>
						</NavItem>
					</a>
				</li>
				<li className="my-px">
					<a href="#"
					   className="flex flex-row items-center h-12 px-4 rounded-lg text-gray-600 hover:bg-gray-100">
						...
						<span className="ml-3">Salarios</span>
					</a>
				</li>
				<li className="my-px">
					<a href="#"
					   className="flex flex-row items-center h-12 px-4 rounded-lg text-gray-600 hover:bg-gray-100">
						...
						<span className="ml-3">Funcionarios</span>
