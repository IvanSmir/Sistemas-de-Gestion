'use client';
import { ListEmployee } from '@/components/transaction/ListEmployee';
    ...
    return (
        <>
            {loading ? (
                ...
                <ListEmployee data={employeeData} columnMapping={columnMapping} setEmployeeData={setEmployeeData} total={total} />
            )}
        </>
    );
};
